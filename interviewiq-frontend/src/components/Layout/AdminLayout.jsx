...
import { LayoutDashboard, Building2, Building, Users, LogOut } from 'lucide-react'

const navItems = [
  { to: '/admin/dashboard', icon: LayoutDashboard, label: 'Dashboard' },
  { to: '/admin/colleges',  icon: Building2,       label: 'Colleges' },
  { to: '/admin/companies', icon: Building,        label: 'Companies' },
  { to: '/admin/tpos',      icon: Users,           label: 'TPO Accounts' },
]
      ...
      <aside className="w-60 flex-shrink-0 flex flex-col z-10"
        ...
        <div className="px-3 py-3" style={{ borderBottom: '1px solid var(--border)' }}>
          <div className="px-3 py-1">
            <div className="text-xs font-semibold" style={{ color: 'var(--muted)' }}>ADMIN PANEL</div>
          </div>
        </div>
        ...
        <div className="px-3 py-4" style={{ borderTop: '1px solid var(--border)' }}>
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1" style={{ background: 'rgba(255,255,255,0.03)' }}>
            ...
            <div className="min-w-0">
              ...
              <div className="text-xs truncate" style={{ color: 'var(--muted)' }}>Administrator</div>
            </div>
          </div>
